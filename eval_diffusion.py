...
import datasets
import utils
from models import NightHaze, NightHazeRestoration
...
def parse_args_and_config():
    ...
    parser.add_argument("--test_set", type=str, default='haze',
...
def main():
    ...
    # create model
    print("=> creating NightHaze...")
    nighthaze = NightHaze(args, config)
    model = NightHazeRestoration(nighthaze, args, config)
    model.restore(val_loader, validation=args.test_set, sid = args.sid)
